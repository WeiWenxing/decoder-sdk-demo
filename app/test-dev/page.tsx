...
// 引用本地 SDK
import { QxanDecoder } from "qxan-decoder-sdk-local";
...
export default function DevPage() {
  ...
  const processInput = async (input: File | string, modeOverride?: boolean) => {
    try {
      ...
      // [Log] Start - 打印详细的调试信息
      console.group("🚀 [DevPage] Process Input Started");
      ...
      setStatus(`Processing (DEV MODE) - Full Decode [expect=${expect}]...`);
      setResult(null); 
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-red-600 p-6 text-white">
          <h1 className="text-2xl font-bold flex items-center gap-2">
            🛠️ SDK Dev Test
            <span className="text-xs bg-red-800 px-2 py-1 rounded text-red-100">Local Source</span>
          </h1>
          <p className="opacity-90 mt-1">Testing local source code from `../qxan-decoder-sdk`</p>
        </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:bg-gray-50 transition-colors cursor-pointer relative flex flex-col justify-center min-h-[120px]">
              ...
              />
              <div className="text-red-600 font-medium">Upload File</div>
